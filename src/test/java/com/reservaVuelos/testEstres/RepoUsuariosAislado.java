...
import com.reservaVuelos.repositorio.ArchivoDAO;
 ...
 */
@Repository
public class RepoUsuariosAislado extends ArchivoDAOAislado<Usuario> {
    ...
    public RepoUsuariosAislado() {
        super("usuariosTest", TOTAL_RECORD_SIZE);
    }
