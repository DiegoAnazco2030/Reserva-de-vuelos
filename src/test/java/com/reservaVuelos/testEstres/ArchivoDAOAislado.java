...
public abstract class ArchivoDAOAislado<T extends Identificador> implements IRepositorio<T> {
    ...
    public ArchivoDAOAislado(String nombreBase, Long tamanoRegistro) {
